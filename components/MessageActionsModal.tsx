...
when you see my message stop fucking read and dont make change please read and make all change complet in real time in this page add a 'Select Text' button in the Export section that opens a full-screen modal with the message content rendered as a selectable Text component (selectable={true} selectionColor prop), along with Copy All and Share buttons at the bottom — so users can highlight and copy specific spans.
