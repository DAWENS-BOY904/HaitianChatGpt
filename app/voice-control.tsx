...
{ hello ai When I’m in voice control mode, I want the keyboard to appear like in photo 1 when I tap the show keyboard . When I tap the screen the keyboard must hide , it should look like photo 2.
...
Never say OpenAI, Google, or any other company name, photo reference: 1:https://files.catbox.moe/iphvyc.png, 2:https://files.catbox.moe/wcmhdu.png.
